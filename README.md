...
A minimal 1-layer transformer with hand-compiled weights that performs exact n-digit addition for any n — something no standard LLM achieves without external tools.
